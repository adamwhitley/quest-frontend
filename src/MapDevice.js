    ...
    return (
      <div className="MapDevice">
          <svg version="1.1" id="tank" x="0px" y="0px" className={this.props.props.state === 1 ? 'Online' : 'Offline'}
               width="30px" height="30px" viewBox="0 0 91.026 90.801" onClick={() => this.props.iconClick(this.props.props.objectId, JSON.parse(this.props.props.infoRaw).location.type.GPS.latitude, JSON.parse(this.props.props.infoRaw).location.type.GPS.longitude)}>
            ...
            c0.162,0.378,0.312,0.76,0.497,1.212C59.598,90.14,29.869,90.14,0,90.14z"/>
                      <path d="M22.088,8.485c2.249-2.577,4.373-5.031,6.532-7.454
            ...
            c2.318,2.404,4.603,4.839,6.895,7.269c0.033,0.035,0.028,0.106,0.055,0.223C52.078,8.485,37.179,8.485,22.088,8.485z"/>
                      <path d="M65.549,56.567c-4.214,0-8.359,0-12.562,0c0-3.396,0-6.754,0-10.187
            c4.157,0,8.322,0,12.562,0C65.549,49.733,65.549,53.111,65.549,56.567z"/>
                      <path d="M52.97,74.223c0-3.403,0-6.758,0-10.184c4.184,0,8.345,0,12.58,0
            c0,3.36,0,6.738,0,10.184C61.401,74.223,57.242,74.223,52.97,74.223z"/>
                      <path d="M52.983,38.25c0-3.275,0-6.504,0-9.782c4.208,0,8.371,0,12.586,0
            c0,3.267,0,6.496,0,9.782C61.364,38.25,57.202,38.25,52.983,38.25z"/>
                      <path d="M52.975,20.568c0-2.454,0-4.848,0-7.293c4.212,0,8.376,0,12.595,0
